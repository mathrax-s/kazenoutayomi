...
public class make_envelope9 extends PApplet {
...
public void make_waveform(float wd, int export) {
  ...
  for (long x=0; x<w; x++) {
    ...
    case 0:
      ...
      noStroke();
      fill(wave_color2[wave_status]);
      rect(x, 640, 1, map( r*wave_ave/128.0f, 0, 128, 0, 255));
...
public void sound_preview() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "make_envelope9" };
    if (passedArgs != null) {
