...
#define CapSense_Sns_INTR_ALL	 ((uint16)(CapSense_Sns_0_INTR| CapSense_Sns_1_INTR| CapSense_Sns_2_INTR| CapSense_Sns_3_INTR| CapSense_Sns_4_INTR| CapSense_Sns_5_INTR| CapSense_Sns_6_INTR| CapSense_Sns_7_INTR| CapSense_Sns_8_INTR| CapSense_Sns_9_INTR| CapSense_Sns_10_INTR| CapSense_Sns_11_INTR))
...
#define CapSense_Sns_LinearSlider0_e10__LS			(CapSense_Sns__LinearSlider0_e10__LS__PC)
#define CapSense_Sns_LinearSlider0_e10__LS_PS		(CapSense_Sns__LinearSlider0_e10__LS__PS)
#define CapSense_Sns_LinearSlider0_e10__LS_PC		(CapSense_Sns__LinearSlider0_e10__LS__PC)
#define CapSense_Sns_LinearSlider0_e10__LS_DR		(CapSense_Sns__LinearSlider0_e10__LS__DR)
#define CapSense_Sns_LinearSlider0_e10__LS_SHIFT	(CapSense_Sns__LinearSlider0_e10__LS__SHIFT)
#define CapSense_Sns_LinearSlider0_e10__LS_INTR	((uint16)((uint16)0x0003u << (CapSense_Sns__10__SHIFT*2u)))

#define CapSense_Sns_LinearSlider0_e11__LS			(CapSense_Sns__LinearSlider0_e11__LS__PC)
#define CapSense_Sns_LinearSlider0_e11__LS_PS		(CapSense_Sns__LinearSlider0_e11__LS__PS)
#define CapSense_Sns_LinearSlider0_e11__LS_PC		(CapSense_Sns__LinearSlider0_e11__LS__PC)
#define CapSense_Sns_LinearSlider0_e11__LS_DR		(CapSense_Sns__LinearSlider0_e11__LS__DR)
#define CapSense_Sns_LinearSlider0_e11__LS_SHIFT	(CapSense_Sns__LinearSlider0_e11__LS__SHIFT)
#define CapSense_Sns_LinearSlider0_e11__LS_INTR	((uint16)((uint16)0x0003u << (CapSense_Sns__11__SHIFT*2u)))
