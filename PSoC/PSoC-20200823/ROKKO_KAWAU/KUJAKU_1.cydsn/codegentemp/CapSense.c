...
reg32 * CapSense_pcTable[] = {
    ...
    (reg32 *)CapSense_Sns__LinearSlider0_e10__LS__PC, 
    (reg32 *)CapSense_Sns__LinearSlider0_e11__LS__PC, 
};
...
const uint8 CapSense_portTable[] = {
    ...
    CapSense_Sns__LinearSlider0_e10__LS__PORT, 
    CapSense_Sns__LinearSlider0_e11__LS__PORT, 
};
...
const uint32 CapSense_maskTable[] = {
    ...
    CapSense_Sns__LinearSlider0_e10__LS__MASK, 
    CapSense_Sns__LinearSlider0_e11__LS__MASK, 
};
...
const uint8 CapSense_pinShiftTbl[] = {
    ...
    (uint8) CapSense_Sns__LinearSlider0_e10__LS__SHIFT, 
    (uint8) CapSense_Sns__LinearSlider0_e11__LS__SHIFT, 
};
